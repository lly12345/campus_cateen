...
public class catelog_servlet extends HttpServlet
{
	...
	public void goods_catelog(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
	//菜品类别删除成功
	{
		List goodscatelog=new ArrayList();
		String sql="select * from t_goods where id="+req.getParameter("id");
		Object[] params={};
		DB mydb=new DB();
		try
		{
		...
		req.setAttribute("goodscatelog", goodscatelog);
