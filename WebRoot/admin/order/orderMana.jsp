			...
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" height="22">  <!--取得订单的各种信息，序号从1开始-->
					...
					<td bgcolor="#FFFFFF" align="center">
					     <c:if test="${order.zhuangtai=='no'}"> <!-- 如果状态=no，显示为接单，点击接单订单触发接收订单orderShouli（id）函数 --> 
					         未接单&nbsp;&nbsp;&nbsp;<a href="#" style="color: red" onclick="orderShouli(${order.id})" class="pn-loperator">接单</a>
					     </c:if>
